...
#include <percept/function/internal/ComputeFieldValues.hpp>
  ...
  namespace percept
  {
    ...
    {
      static BasisTypeRCP a1 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_HEX_C1_FEM<double, MDArray >() );

      // FIXME
      static BasisTypeRCP a2 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_LINE_C1_FEM<double, MDArray >() );
      static BasisTypeRCP a3 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_TRI_C1_FEM<double, MDArray >() );
      static BasisTypeRCP a4 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_TRI_C2_FEM<double, MDArray >() );

      static BasisTypeRCP a5 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C1_FEM<double, MDArray >() );
      // static BasisTypeRCP a6 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C2_Serendipity_FEM<double, MDArray >() );
      static BasisTypeRCP a7 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C2_FEM<double, MDArray >() );

      static BasisTypeRCP a8 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_HEX_C1_FEM<double, MDArray >() );
      //static BasisTypeRCP a9 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_HEX_C2_Serendipity_FEM<double, MDArray >() );
      static BasisTypeRCP a10 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_HEX_C2_FEM<double, MDArray >() );

      static BasisTypeRCP a11 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_TET_C1_FEM<double, MDArray >() );
      static BasisTypeRCP a12 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_TET_C2_FEM<double, MDArray >() );

      static BasisTypeRCP a13 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_WEDGE_C1_FEM<double, MDArray >() );

      // Intrepid2 doesn't support wedge 15
      //static BasisTypeRCP a14 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_WEDGE_C2_Serendipity_FEM<double, MDArray >() );


      // Shells
      static BasisTypeRCP a15 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_TRI_C1_FEM<double, MDArray >() );
      static BasisTypeRCP a16 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_TRI_C2_FEM<double, MDArray >() );
      static BasisTypeRCP a17 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C1_FEM<double, MDArray >() );
      //static BasisTypeRCP a18 = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C2_Serendipity_FEM<double, MDArray >() );
    }
#endif
    ...
    operator()(Jacobian& J, int i_face, CellTopology& topo)
    {
      ...
      MDArray J_mda;
      J.copyTo(J_mda);
      MDArray fn_mda("fn_mda", m_im.m_Elements_Tag.num, m_im.m_Cub_Points_Tag.num, m_im.m_Spatial_Dim_Tag.num);
      Intrepid2::CellTools<Kokkos::HostSpace>::getPhysicalFaceNormals(fn_mda, J_mda, i_face, cell_topo);
    ...
    {
      Kokkos::deep_copy(*this, Kokkos::subview(mda, Kokkos::ALL(), Kokkos::ALL(), iDof));
     // Kokkos::deep_copy(*this, Kokkos::subview(mda, Kokkos::ALL(), Kokkos::ALL(), std::make_pair(iDof,iDof+1));
...
#if 0
      for (int iDof = 0; iDof < iv.extent_int(2); iDof++)
        {
          Integral Is(...);
