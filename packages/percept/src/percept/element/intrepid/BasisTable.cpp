...
//#include <percept/Intrepid2_HGRAD_WEDGE_C2_Serendipity_FEM.hpp>
//#include <percept/Intrepid2_HGRAD_QUAD_C2_Serendipity_FEM.hpp>
//#include <percept/Intrepid2_HGRAD_HEX_C2_Serendipity_FEM.hpp>
//#include <percept/Intrepid2_HGRAD_HEX_C2_Serendipity_FEM.hpp>
...
#include <percept/element/intrepid/BasisTable.hpp>
  ...
  namespace percept {
    ...
    {
      /// from the Intrepid2 documentation, these are the only cell topologies currently supported for inverse mappings
     ...
     // m_basisTable[shards::getCellTopologyData<shards::Quadrilateral<8> >()-> key] = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C2_Serendipity_FEM<double, MDArray >() );
     ...
     // m_basisTable[shards::getCellTopologyData<shards::Hexahedron<20> >()-> key]   = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_HEX_C2_Serendipity_FEM<double, MDArray >() );
     ...
     // m_basisTable[shards::getCellTopologyData<shards::Wedge<15> >()-> key]        = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_WEDGE_C2_Serendipity_FEM<Kokkos::HostSpace, double, double >() );
     ...
     // m_basisTable[shards::getCellTopologyData<shards::ShellQuadrilateral<8> >()-> key] = Teuchos::rcp ( new Intrepid2::Basis_HGRAD_QUAD_C2_Serendipity_FEM<Kokkos::HostSpace, double, double>() );
